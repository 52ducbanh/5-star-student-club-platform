/**
 * Client-side STARPRINT v2 SUPPORT puzzle definitions.
 * Matches server definitions in support-puzzles-v2.config.ts.
 */

export interface ClientRope {
  ropeId: string;
  label: string;
  // Visual positions in SVG coordinate space (0-100%)
  x1: number;
  y1: number;
  x2: number;
  y2: number;
...
export interface ClientSupportPuzzle {
  puzzleId: string;
  title: string;
  instruction: string;
...
export const SUPPORT_PUZZLES_CLIENT: ClientSupportPuzzle[] = [
  {
